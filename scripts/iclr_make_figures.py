...
def fig1():
    ...
    plt.tight_layout(); plt.savefig(FIG / "fig1_recognize_vs_generate.pdf"); plt.close()
    print("fig1 done")
...
def fig2():
    ...
    plt.savefig(FIG / "fig2_zero_shot_routing.pdf"); plt.close()
    print("fig2 done")
...
def fig3():
    ...
    plt.savefig(FIG / "fig3_layerwise.pdf"); plt.close()
    print("fig3 done")
...
def fig4():
    ...
    plt.tight_layout(); plt.savefig(FIG / "fig4_real_data_routing.pdf"); plt.close()
    print("fig4 done")
...
def fig5():
    ...
    plt.tight_layout(); plt.savefig(FIG / "fig5_asymmetry_sweeps.pdf"); plt.close()
    print("fig5 done")
